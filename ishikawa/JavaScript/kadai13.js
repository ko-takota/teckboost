...
// 商品の定義
var itemList = [
    { id: '0001', price: '¥12,000~', name: 'ソファベッド', tags: ['ベッド', 'ソファ', '寝具'] },
    { id: '0002', price: '¥8,000~', name: 'シングルベッド', tags: ['ベッド', 'ソファ', '寝具'] },
    { id: '0003', price: '¥6,000~', name: '子ども用ベッド', tags: ['ベッド', 'ソファ', '寝具', '子ども部屋家具'] },
    { id: '0004', price: '¥4,500~', name: 'ソファ', tags: ['ソファ'] },
    { id: '0005', price: '¥1500~', name: 'キューブボックス', tags: ['家具・ラック', '収納システム'] },
    { id: '0006', price: '¥3,000~', name: 'オープンラック', tags: ['家具・ラック', '収納システム'] },
    { id: '0007', price: '¥10,000~', name: 'コンピュータデスク', tags: ['テーブル・椅子'] },
    { id: '0008', price: '¥2,000~', name: 'サイドテーブル', tags: ['テーブル・椅子'] },
    { id: '0009', price: '¥2,000~', name: 'ダイニングテーブル', tags: ['テーブル・椅子'] },
    { id: '0010', price: '¥1,000~', name: '子ども部屋用収納', tags: ['収納システム', '子ども部屋家具'] },
    { id: '0011', price: '¥2,000~', name: '調理カット', tags: ['ナイフ','包丁','ピーラー']},
    { id: '0012', price: '¥4,000~', name: '調理器具', tags: ['ステンレスフライパン','ホットプレート','鍋']},
];
...
function setSubMenu(idx) {
    // console.log(cate2[idx]);
    // console.log('setSubMenu',cate2);
    // 取得したselectの子要素（option）を空白にすることによってすべて削除
    cate2Element.innerHTML = '';

    cate2[idx].forEach(function(value,index){
        // console.log(index)
        // console.log(value)
        let option = document.createElement('option');
        option.value = value;
...
function viewItemList(tag) {
    ...
    itemList.forEach(function(item) {
        if (item.tags.some(t => t === tag)) {
            ...
            let text = document.createTextNode(item.price + ' ' + item.name);
            li.appendChild(text);
